...
def model_average_plot(data, rewards, action_matrix, arm_means, top=None, alpha=0.15):
    """
    ...
    plt.plot(rolling_avg_rewards, color="black", linewidth=1.5,alpha = 0.4, label="Actual Rewards")

    # plt.xlabel("Time Steps")
    # plt.ylabel("Average Reward / Selection Rate")
    # plt.grid(True, alpha=0.3)
    # plt.title.set_text("Actual Rewards")
